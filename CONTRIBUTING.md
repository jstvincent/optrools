...
- Some portal downloads may share the same `info.version` (for example multiple `26.0.0` builds); diffs are generated by `info.version` and may treat those as the same version.
